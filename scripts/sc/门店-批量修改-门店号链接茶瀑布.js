 ...
 * @动作    批量写
 * @风险    高
 * @来源    store-data-extractor/XiuGaiWeiXinMenDianHaoLinkChaPuBu.js
...
const config = {
  ...
  logPath: path.join(__dirname, '../output', '执行日志_茶瀑布.txt'), // 日志文件路径
  baseUrl: 'https://vinci-api.feibing.tech/sc/v1/sellers/wpV3cNDAAA3ZRQDQZt0UsR9wORkx0thg/configs',
  // 需要被替换的目标链接
  targetLink: 'https://work.weixin.qq.com/gm/3161bcd305260ba3d3741d2ab89649ed',
